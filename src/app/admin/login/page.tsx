...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4">
      <div className="w-full max-w-md bg-white/95 backdrop-blur rounded-2xl shadow-2xl border border-gray-100 p-8 max-md:p-5">
        <div className="flex flex-col items-center mb-8">
          <Image
            ...
            unoptimized
          />
          <h1 className="text-2xl font-bold mt-4 text-gray-900">Master Admin</h1>
          <p className="text-sm text-gray-500">Sign in to manage projects and users</p>
        </div>
